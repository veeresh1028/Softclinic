...
{
    #region DHA Report 1 (Patients Visit Count By Nationalities)
    public class PatientCountByNationality
    {
        public int pad_age { get; set; }
        public string diag_code_name { get; set; }
        public string pad_nat_val { get; set; }
    ...
    public class PatientCountReportSearch
    {
    ...
    public class PatientCountByNationalityTreatments
    {
        public int pad_age { get; set; }
        public string tr_code_name { get; set; }
        public string pad_nat_val { get; set; }
        public int M_0_1 { get; set; }
        public int F_0_1 { get; set; }
        public int M_1_4 { get; set; }
    ...
    public class PatientCountReportTreatmentsSearch
    {
        public int search_type { get; set; } = 0;
        public string select_branch { get; set; }
        public int select_month { get; set; }
