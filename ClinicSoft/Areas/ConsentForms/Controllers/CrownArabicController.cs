...
{
    //CSIndia 2 Comment for testing --> Reply comment By Alan
    public class CrownArabicController : Controller
    {
        int PageId = (int)Pages.DentalConsentForms;

        // GET: ConsentForms/CrownArabic

        public ActionResult CrownArabicIndex()
        {
            ViewBag.Tab = "0";
        ...
        public JsonResult GetCrownArabicData(int appId)
        {
            int Action = (int)Actions.Read;

            if (PageControl.haveAccess(PageId, Action))
            {
                List<BusinessEntities.ConcentForms.CrownArabic> list = BusinessLogicLayer.ConcentForms.CrownArabic.GetCrownArabicData(appId);
        ...
        public PartialViewResult CreateCrownArabic()
        {
            if (PageControl.getLoggedinId() > 0)
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    return PartialView("CreateCrownArabic");
                }
                else
                {
        ...
        public ActionResult InsertCrownArabic(BusinessEntities.ConcentForms.CrownArabic data)
        {
            int isInserted = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.CrownArabic.isValidCrownArabic(data, out errors))
                    {
                        isInserted = BusinessLogicLayer.ConcentForms.CrownArabic.SaveCrownArabic(data, madeby);

                        if (isInserted > 0)
                        {
                            PDF _pdf = CreatePDF(data.icca_appId, "CrownArabic");
                            return Json(new { isInserted = true, isSuccess = true, message = "Done" }, JsonRequestBehavior.AllowGet);
                        }
                        else
                        {
                            return Json(new { isInserted = false, isSuccess = true, message = "Crown Arabic is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        public PartialViewResult UpdateCrownArabic(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Create;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    BusinessEntities.ConcentForms.CrownArabic crown = BusinessLogicLayer.ConcentForms.CrownArabic.GetCrownArabicData(appId).FirstOrDefault();

                    return PartialView("UpdateCrownArabic", crown);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditCrownArabic(BusinessEntities.ConcentForms.CrownArabic data)
        {
            int isEdited = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.CrownArabic.isValidCrownArabic(data, out errors))
                    {
                        isEdited = BusinessLogicLayer.ConcentForms.CrownArabic.SaveCrownArabic(data, madeby);
                        ...
                        {
                            return Json(new { isEdited = false, isSuccess = true, message = "Crown Arabic is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        // Delete 
        [HttpPost]
        public ActionResult DeleteCrownArabic(int appId)
        {
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    int val = BusinessLogicLayer.ConcentForms.CrownArabic.DeleteCrownArabic(appId, madeby);
        ...
        public PartialViewResult CrownArabicPreviousHistory(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Read;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    List<BusinessEntities.ConcentForms.ConcentPreviousHistroy> list = BusinessLogicLayer.ConcentForms.CrownArabic.GetCrownArabicPreviousHistory(appId);
                    return PartialView("CrownArabicPreviousHistory", list);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public PDF CreatePDF(int appId, string form)
        {
            ...
            try
            {
                ...
                string htmlContent = BusinessLogicLayer.ConcentForms.ConsentFormPDF.HtmlCrownArabic(appId, emr, setId);
