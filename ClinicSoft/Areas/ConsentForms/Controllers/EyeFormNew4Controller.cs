...
{
    public class EyeFormNew4Controller : Controller
    {
        int PageId = (int)Pages.OphthalmologyConsentForms;
        // GET: ConsentForms/EyeFormNew4
        public ActionResult EyeFormNew4Index()
        {
            ViewBag.Tab = "0";

            return View();
        }
        public JsonResult GetEyeFormNew4Data(int appId)
        {
            int Action = (int)Actions.Read;

            if (PageControl.haveAccess(PageId, Action))
            {
                List<BusinessEntities.ConsentForms.EyeFormNew4> list = BusinessLogicLayer.ConsentForms.EyeFormNew4.GetEyeFormNew4Data(appId);
        ...
        public PartialViewResult CreateEyeFormNew4()
        {
            if (PageControl.getLoggedinId() > 0)
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    return PartialView("CreateEyeFormNew4");
                }
                else
                {
        ...
        public ActionResult InsertEyeFormNew4(BusinessEntities.ConsentForms.EyeFormNew4 data)
        {
            int isInserted = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    {
                        string file_path = Server.MapPath("~/images/ConsentForms/SavedImages/eyeform_4/");
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.EyeFormNew4.isValidEyeFormNew4(data, out errors))
                    {
                        isInserted = BusinessLogicLayer.ConsentForms.EyeFormNew4.SaveEyeFormNew4(data, madeby);

                        if (isInserted > 0)
                        {

                             PDF _pdf = CreatePDF(data.efn4_appId, "EyeFormNew4");
                            return Json(new { isInserted = true, isSuccess = true, message = "Done" }, JsonRequestBehavior.AllowGet);
                        }
                        else
                        {
                            return Json(new { isInserted = false, isSuccess = true, message = "EyeFormNew4 is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        public PartialViewResult UpdateEyeFormNew4(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Create;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    BusinessEntities.ConsentForms.EyeFormNew4 eye = BusinessLogicLayer.ConsentForms.EyeFormNew4.GetEyeFormNew4Data(appId).FirstOrDefault();

                    return PartialView("UpdateEyeFormNew4", eye);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditEyeFormNew4(BusinessEntities.ConsentForms.EyeFormNew4 data)
        {
            int isEdited = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.EyeFormNew4.isValidEyeFormNew4(data, out errors))
                    {
                        isEdited = BusinessLogicLayer.ConsentForms.EyeFormNew4.SaveEyeFormNew4(data, madeby);
                        ...
                        {
                            return Json(new { isEdited = false, isSuccess = true, message = "EyeFormNew4 is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        // Delete 
        [HttpPost]
        public ActionResult DeleteEyeFormNew4(int appId)
        {
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    int val = BusinessLogicLayer.ConsentForms.EyeFormNew4.DeleteEyeFormNew4(appId, madeby);
        ...
        public PartialViewResult EyeFormNew4PreviousHistory(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Read;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    List<BusinessEntities.ConcentForms.ConcentPreviousHistroy> list = BusinessLogicLayer.ConsentForms.EyeFormNew4.GetEyeFormNew4PreviousHistory(appId);
                    return PartialView("EyeFormNew4PreviousHistory", list);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public PDF CreatePDF(int appId, string form)
        {
            ...
            try
            {
                ...
                string htmlContent = BusinessLogicLayer.ConcentForms.ConsentFormPDF.HtmlEyeFormNew4(appId, emr, setId);
