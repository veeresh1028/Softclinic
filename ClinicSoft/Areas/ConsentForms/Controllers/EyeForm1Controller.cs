...
{
    public class EyeForm1Controller : Controller
    {
        int PageId = (int)Pages.OphthalmologyConsentForms;
        // GET: ConsentForms/EyeForm1
        public ActionResult EyeForm1Index()
        {
            ViewBag.Tab = "0";

            return View();
        }
        public JsonResult GetEyeForm1Data(int appId)
        {
            int Action = (int)Actions.Read;

            if (PageControl.haveAccess(PageId, Action))
            {
                List<BusinessEntities.ConsentForms.EyeForm1> list = BusinessLogicLayer.ConsentForms.EyeForm1.GetEyeForm1Data(appId);
        ...
        public PartialViewResult CreateEyeForm1()
        {
            if (PageControl.getLoggedinId() > 0)
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    return PartialView("CreateEyeForm1");
                }
                else
                {
        ...
        [HttpPost]
        public ActionResult InsertEyeForm(BusinessEntities.ConsentForms.EyeForm1 data)
        {
            int isInserted = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    {
                        string file_path = Server.MapPath("~/images/ConsentForms/SavedImages/eye_1/");
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.EyeForm1.isValidEyeForm1(data, out errors))
                    {
                        isInserted = BusinessLogicLayer.ConsentForms.EyeForm1.SaveEyeForm1(data, madeby);

                        if (isInserted > 0)
                        {
                            PDF _pdf = CreatePDF(data.efn1_appId, "EyeForm1");
                            return Json(new { isInserted = true, isSuccess = true, message = "Done" }, JsonRequestBehavior.AllowGet);
                        }
                        else
                        {
                            return Json(new { isInserted = false, isSuccess = true, message = "Eye Form1 Form is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        public PartialViewResult UpdateEyeForm1(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Create;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    BusinessEntities.ConsentForms.EyeForm1 ophtha = BusinessLogicLayer.ConsentForms.EyeForm1.GetEyeForm1Data(appId).FirstOrDefault();
                    return PartialView("UpdateEyeForm1", ophtha);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public ActionResult EditEyeForm1(BusinessEntities.ConsentForms.EyeForm1 data)
        {
            int isEdited = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.EyeForm1.isValidEyeForm1(data, out errors))
                    {
                        isEdited = BusinessLogicLayer.ConsentForms.EyeForm1.SaveEyeForm1(data, madeby);
                        ...
                        {
                            return Json(new { isEdited = false, isSuccess = true, message = "Eye Form1 Form is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        // Delete 
        [HttpPost]
        public ActionResult DeleteEyeForm1(int appId)
        {
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    int val = BusinessLogicLayer.ConsentForms.EyeForm1.DeleteEyeForm1(appId, madeby);
        ...
        public PartialViewResult EyeForm1PreviousHistory(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Read;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    List<BusinessEntities.ConcentForms.ConcentPreviousHistory> list = BusinessLogicLayer.ConsentForms.EyeForm1.GetEyeForm1PreviousHistory(appId);
                    return PartialView("EyeForm1PreviousHistory", list);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public PDF CreatePDF(int appId, string form)
        {
            ...
            try
            {
                ...
                string htmlContent = BusinessLogicLayer.ConcentForms.ConcentFormPDF.HtmlEyeForm1(appId, emr, setId);
