...
{
    public class PhysiotherapyAssessmentController : Controller
    {
        int PageId = (int)Pages.HijamaConsentForms;
        // GET: ConsentForms/PhysiotherapyAssessment
        public ActionResult PhysiotherapyAssessmentIndex()
        {
            ViewBag.Tab = "0";

            return View();
        }
        public JsonResult GetPhysiotherapyAssessmentData(int appId)
        {
            int Action = (int)Actions.Read;

            if (PageControl.haveAccess(PageId, Action))
            {
                List<BusinessEntities.ConsentForms.PhysiotherapyAssessment> list = BusinessLogicLayer.ConsentForms.PhysiotherapyAssessment.GetPhysiotherapyAssessmentData(appId);
        ...
        public PartialViewResult CreatePhysiotherapyAssessment()
        {
            if (PageControl.getLoggedinId() > 0)
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    return PartialView("CreatePhysiotherapyAssessment");
                }
                else
                {
        ...
        public ActionResult InsertPhysiotherapyAssessment(BusinessEntities.ConsentForms.PhysiotherapyAssessment data)
        {
            int isInserted = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    {
                        string file_path = Server.MapPath("~/images/ConsentForms/SavedImages/physiotherapy/");
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.PhysiotherapyAssessment.isValidPhysiotherapyAssessment(data, out errors))
                    {
                        isInserted = BusinessLogicLayer.ConsentForms.PhysiotherapyAssessment.SavePhysiotherapyAssessment(data, madeby);

                        if (isInserted > 0)
                        {

                            PDF _pdf = CreatePDF(data.paf_appId, "PhysiotherapyAssessment");
                            return Json(new { isInserted = true, isSuccess = true, message = "Done" }, JsonRequestBehavior.AllowGet);
                        }
                        else
                        {
                            return Json(new { isInserted = false, isSuccess = true, message = "Physiotherapy Assessment Consent is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        public PartialViewResult UpdatePhysiotherapyAssessment(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Create;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    BusinessEntities.ConsentForms.PhysiotherapyAssessment physiotherapy = BusinessLogicLayer.ConsentForms.PhysiotherapyAssessment.GetPhysiotherapyAssessmentData(appId).FirstOrDefault();

                    return PartialView("UpdatePhysiotherapyAssessment", physiotherapy);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditPhysiotherapyAssessment(BusinessEntities.ConsentForms.PhysiotherapyAssessment data)
        {
            int isEdited = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.PhysiotherapyAssessment.isValidPhysiotherapyAssessment(data, out errors))
                    {
                        isEdited = BusinessLogicLayer.ConsentForms.PhysiotherapyAssessment.SavePhysiotherapyAssessment(data, madeby);
                        ...
                        {
                            return Json(new { isEdited = false, isSuccess = true, message = "Physiotherapy Assessment is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        // Delete 
        [HttpPost]
        public ActionResult DeletePhysiotherapyAssessment(int appId)
        {
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    int val = BusinessLogicLayer.ConsentForms.PhysiotherapyAssessment.DeletePhysiotherapyAssessment(appId, madeby);
        ...
        public PartialViewResult PhysiotherapyAssessmentPreviousHistory(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Read;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    List<BusinessEntities.ConcentForms.ConcentPreviousHistroy> list = BusinessLogicLayer.ConsentForms.PhysiotherapyAssessment.GetPhysiotherapyAssessmentPreviousHistory(appId);
                    return PartialView("PhysiotherapyAssessmentPreviousHistory", list);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public PDF CreatePDF(int appId, string form)
        {
            ...
            try
            {
                ...
                string htmlContent = BusinessLogicLayer.ConcentForms.ConsentFormPDF.HtmlPhysiotherapyAssessment(appId, emr, setId);
