...
{
    public class EyeForm2Controller : Controller
    {
        int PageId = (int)Pages.OphthalmologyConsentForms;
        // GET: ConsentForms/EyeForm2
        public ActionResult EyeForm2Index()
        {
            ViewBag.Tab = "0";

            return View();
        }
        public JsonResult GetEyeForm2Data(int appId)
        {
            int Action = (int)Actions.Read;

            if (PageControl.haveAccess(PageId, Action))
            {
                List<BusinessEntities.ConsentForms.EyeForm2> list = BusinessLogicLayer.ConsentForms.EyeForm2.GetEyeForm2Data(appId);
        ...
        public PartialViewResult CreateEyeForm2()
        {
            if (PageControl.getLoggedinId() > 0)
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    return PartialView("CreateEyeForm2");
                }
                else
                {
        ...
        [HttpPost]
        public ActionResult InsertEyeForm(BusinessEntities.ConsentForms.EyeForm2 data)
        {
            int isInserted = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    {
                        string file_path = Server.MapPath("~/images/ConsentForms/SavedImages/eye_2/");
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.EyeForm2.isValidEyeForm2(data, out errors))
                    {
                        isInserted = BusinessLogicLayer.ConsentForms.EyeForm2.SaveEyeForm2(data, madeby);

                        if (isInserted > 0)
                        {
                            PDF _pdf = CreatePDF(data.efn2_appId, "EyeForm2");
                            return Json(new { isInserted = true, isSuccess = true, message = "Done" }, JsonRequestBehavior.AllowGet);
                        }
                        else
                        {
                            return Json(new { isInserted = false, isSuccess = true, message = "Eye Form2 Form is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        public PartialViewResult UpdateEyeForm2(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Create;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    BusinessEntities.ConsentForms.EyeForm2 ophtha = BusinessLogicLayer.ConsentForms.EyeForm2.GetEyeForm2Data(appId).FirstOrDefault();
                    return PartialView("UpdateEyeForm2", ophtha);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public ActionResult EditEyeForm2(BusinessEntities.ConsentForms.EyeForm2 data)
        {
            int isEdited = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.EyeForm2.isValidEyeForm2(data, out errors))
                    {
                        isEdited = BusinessLogicLayer.ConsentForms.EyeForm2.SaveEyeForm2(data, madeby);
                        ...
                        {
                            return Json(new { isEdited = false, isSuccess = true, message = "Eye Form2 Form is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        // Delete 
        [HttpPost]
        public ActionResult DeleteEyeForm2(int appId)
        {
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    int val = BusinessLogicLayer.ConsentForms.EyeForm2.DeleteEyeForm2(appId, madeby);
        ...
        public PartialViewResult EyeForm2PreviousHistory(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Read;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    List<BusinessEntities.ConcentForms.ConcentPreviousHistory> list = BusinessLogicLayer.ConsentForms.EyeForm2.GetEyeForm2PreviousHistory(appId);
                    return PartialView("EyeForm2PreviousHistory", list);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public PDF CreatePDF(int appId, string form)
        {
            ...
            try
            {
                ...
                string htmlContent = BusinessLogicLayer.ConcentForms.ConcentFormPDF.HtmlEyeForm2(appId, emr, setId);
