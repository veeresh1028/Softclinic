...
{
    public class LaserHairRemovalController : Controller
    {
        int PageId = (int)Pages.DermatologyConsentForms;
        // GET: ConsentForms/LaserHairRemoval
        public ActionResult LaserHairRemovalIndex()
        {
            ViewBag.Tab = "0";

            return View();
        }
        public JsonResult GetLaserHairRemovalData(int appId)
        {
            int Action = (int)Actions.Read;

            if (PageControl.haveAccess(PageId, Action))
            {
                List<BusinessEntities.ConsentForms.LaserHairRemoval> list = BusinessLogicLayer.ConsentForms.LaserHairRemoval.GetLaserHairRemovalData(appId);
        ...
        public PartialViewResult CreateLaserHairRemoval()
        {
            if (PageControl.getLoggedinId() > 0)
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    return PartialView("CreateLaserHairRemoval");
                }
                else
                {
        ...
        [HttpPost]
        public ActionResult InsertLaserHairRemoval(BusinessEntities.ConsentForms.LaserHairRemoval data)
        {
            int isInserted = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    {
                        string file_path = Server.MapPath("~/images/ConsentForms/SavedImages/LaserHair/");
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.LaserHairRemoval.isValidLaserHairRemoval(data, out errors))
                    {
                        isInserted = BusinessLogicLayer.ConsentForms.LaserHairRemoval.SaveLaserHairRemoval(data, madeby);

                        if (isInserted > 0)
                        {
                            PDF _pdf = CreatePDF(data.lhr_appId, "LaserHairRemoval");
                            return Json(new { isInserted = true, isSuccess = true, message = "Done" }, JsonRequestBehavior.AllowGet);
                        }
                        else
                        {
                            return Json(new { isInserted = false, isSuccess = true, message = "Laser Hair Removal Form is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        public PartialViewResult UpdateLaserHairRemoval(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Create;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    BusinessEntities.ConsentForms.LaserHairRemoval ophtha = BusinessLogicLayer.ConsentForms.LaserHairRemoval.GetLaserHairRemovalData(appId).FirstOrDefault();
                    return PartialView("UpdateLaserHairRemoval", ophtha);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public ActionResult EditLaserHairRemoval(BusinessEntities.ConsentForms.LaserHairRemoval data)
        {
            int isEdited = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.LaserHairRemoval.isValidLaserHairRemoval(data, out errors))
                    {
                        isEdited = BusinessLogicLayer.ConsentForms.LaserHairRemoval.SaveLaserHairRemoval(data, madeby);
                        ...
                        {
                            return Json(new { isEdited = false, isSuccess = true, message = "Laser Hair Removal Form is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        // Delete 
        [HttpPost]
        public ActionResult DeleteLaserHairRemoval(int appId)
        {
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    int val = BusinessLogicLayer.ConsentForms.LaserHairRemoval.DeleteLaserHairRemoval(appId, madeby);
        ...
        public PartialViewResult LaserHairRemovalPreviousHistory(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Read;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    List<BusinessEntities.ConcentForms.ConcentPreviousHistory> list = BusinessLogicLayer.ConsentForms.LaserHairRemoval.GetLaserHairRemovalPreviousHistory(appId);
                    return PartialView("LaserHairRemovalPreviousHistory", list);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public PDF CreatePDF(int appId, string form)
        {
            ...
            try
            {
                ...
                string htmlContent = BusinessLogicLayer.ConcentForms.ConcentFormPDF.HtmlLaserHairRemoval(appId, emr, setId);
