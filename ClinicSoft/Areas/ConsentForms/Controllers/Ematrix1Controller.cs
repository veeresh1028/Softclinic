...
{
    public class Ematrix1Controller : Controller
    {
        int PageId = (int)Pages.LaserConsentForms;
        // GET: ConsentForms/Ematrix1
        public ActionResult Ematrix1Index()
        {
            ViewBag.Tab = "0";
        ...
        public JsonResult GetEmatrix1Data(int appId)
        {
            int Action = (int)Actions.Read;

            if (PageControl.haveAccess(PageId, Action))
            {
                List<BusinessEntities.ConsentForms.Ematrix1> list = BusinessLogicLayer.ConsentForms.Ematrix1.GetEmatrix1Data(appId);
        ...
        public PartialViewResult CreateEmatrix1()
        {
            if (PageControl.getLoggedinId() > 0)
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    return PartialView("CreateEmatrix1");
                }
                else
                {
        ...
        public ActionResult InsertEmatrix1(BusinessEntities.ConsentForms.Ematrix1 data)
        {
            int isInserted = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.Ematrix1.isValidEmatrix1(data, out errors))
                    {
                        isInserted = BusinessLogicLayer.ConsentForms.Ematrix1.SaveEmatrix1(data, madeby);

                        if (isInserted > 0)
                        {

                           PDF _pdf = CreatePDF(data.cef_appId, "Ematrix1");
                            return Json(new { isInserted = true, isSuccess = true, message = "Done" }, JsonRequestBehavior.AllowGet);
                        }
                        else
                        {
                            return Json(new { isInserted = false, isSuccess = true, message = "Ematrix1 Consent is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        public PartialViewResult UpdateEmatrix1(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Create;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    BusinessEntities.ConsentForms.Ematrix1 ematrix = BusinessLogicLayer.ConsentForms.Ematrix1.GetEmatrix1Data(appId).FirstOrDefault();

                    return PartialView("UpdateEmatrix1", ematrix);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditEmatrix1(BusinessEntities.ConsentForms.Ematrix1 data)
        {
            int isEdited = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.Ematrix1.isValidEmatrix1(data, out errors))
                    {
                        isEdited = BusinessLogicLayer.ConsentForms.Ematrix1.SaveEmatrix1(data, madeby);
                        ...
                        {
                            return Json(new { isEdited = false, isSuccess = true, message = "Ematrix1 Consent is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        // Delete 
        [HttpPost]
        public ActionResult DeleteEmatrix1(int appId)
        {
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    int val = BusinessLogicLayer.ConsentForms.Ematrix1.DeleteEmatrix1(appId, madeby);
        ...
        public PartialViewResult Ematrix1PreviousHistory(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Read;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    List<BusinessEntities.ConcentForms.ConcentPreviousHistroy> list = BusinessLogicLayer.ConsentForms.Ematrix1.GetEmatrix1PreviousHistory(appId);
                    return PartialView("Ematrix1PreviousHistory", list);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public PDF CreatePDF(int appId, string form)
        {
            ...
            try
            {
                ...
                string htmlContent = BusinessLogicLayer.ConcentForms.ConsentFormPDF.HtmlEmatrix1(appId, emr, setId);
