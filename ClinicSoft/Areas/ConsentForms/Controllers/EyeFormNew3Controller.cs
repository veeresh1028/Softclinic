...
{
    public class EyeFormNew3Controller : Controller
    {
        int PageId = (int)Pages.OphthalmologyConsentForms;
        // GET: ConsentForms/EyeFormNew3
        public ActionResult EyeFormNew3Index()
        {
            ViewBag.Tab = "0";

            return View();
        }
        public JsonResult GetEyeFormNew3Data(int appId)
        {
            int Action = (int)Actions.Read;

            if (PageControl.haveAccess(PageId, Action))
            {
                List<BusinessEntities.ConsentForms.EyeFormNew3> list = BusinessLogicLayer.ConsentForms.EyeFormNew3.GetEyeFormNew3Data(appId);
        ...
        public PartialViewResult CreateEyeFormNew3()
        {
            if (PageControl.getLoggedinId() > 0)
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    return PartialView("CreateEyeFormNew3");
                }
                else
                {
        ...
        public ActionResult InsertEyeFormNew3(BusinessEntities.ConsentForms.EyeFormNew3 data)
        {
            int isInserted = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    {
                        string file_path = Server.MapPath("~/images/ConsentForms/SavedImages/eyeform_3/");
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.EyeFormNew3.isValidEyeFormNew3(data, out errors))
                    {
                        isInserted = BusinessLogicLayer.ConsentForms.EyeFormNew3.SaveEyeFormNew3(data, madeby);

                        if (isInserted > 0)
                        {

                            PDF _pdf = CreatePDF(data.efn3_appId, "EyeFormNew3");
                            return Json(new { isInserted = true, isSuccess = true, message = "Done" }, JsonRequestBehavior.AllowGet);
                        }
                        else
                        {
                            return Json(new { isInserted = false, isSuccess = true, message = "EyeFormNew3 is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        public PartialViewResult UpdateEyeFormNew3(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Create;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    BusinessEntities.ConsentForms.EyeFormNew3 eye = BusinessLogicLayer.ConsentForms.EyeFormNew3.GetEyeFormNew3Data(appId).FirstOrDefault();

                    return PartialView("UpdateEyeFormNew3", eye);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditEyeFormNew3(BusinessEntities.ConsentForms.EyeFormNew3 data)
        {
            int isEdited = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.EyeFormNew3.isValidEyeFormNew3(data, out errors))
                    {
                        isEdited = BusinessLogicLayer.ConsentForms.EyeFormNew3.SaveEyeFormNew3(data, madeby);
                        ...
                        {
                            return Json(new { isEdited = false, isSuccess = true, message = "EyeFormNew3 is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        // Delete 
        [HttpPost]
        public ActionResult DeleteEyeFormNew3(int appId)
        {
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    int val = BusinessLogicLayer.ConsentForms.EyeFormNew3.DeleteEyeFormNew3(appId, madeby);
        ...
        public PartialViewResult EyeFormNew3PreviousHistory(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Read;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    List<BusinessEntities.ConcentForms.ConcentPreviousHistroy> list = BusinessLogicLayer.ConsentForms.EyeFormNew3.GetEyeFormNew3PreviousHistory(appId);
                    return PartialView("EyeFormNew3PreviousHistory", list);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public PDF CreatePDF(int appId, string form)
        {
            ...
            try
            {
                ...
                string htmlContent = BusinessLogicLayer.ConcentForms.ConsentFormPDF.HtmlEyeFormNew3(appId, emr, setId);
