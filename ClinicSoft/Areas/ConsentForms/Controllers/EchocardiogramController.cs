...
{
    public class EchocardiogramController : Controller
    {
        int PageId = (int)Pages.CardiologyConsentForms;
        // GET: ConsentForms/Echocardiogram
        public ActionResult EchocardiogramIndex()
        {
            ViewBag.Tab = "0";

            return View();
        }
        public JsonResult GetEchocardiogramData(int appId)
        {
            int Action = (int)Actions.Read;

            if (PageControl.haveAccess(PageId, Action))
            {
                List<BusinessEntities.ConsentForms.Echocardiogram> list = BusinessLogicLayer.ConsentForms.Echocardiogram.GetEchocardiogramData(appId);
        ...
        public PartialViewResult CreateEchocardiogram()
        {
            if (PageControl.getLoggedinId() > 0)
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    return PartialView("CreateEchocardiogram");
                }
                else
                {
        ...
        [HttpPost]
        public ActionResult InsertEchocardiogram(BusinessEntities.ConsentForms.Echocardiogram data)
        {
            int isInserted = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    {
                        string file_path = Server.MapPath("~/images/ConsentForms/SavedImages/Echocardiogram/");
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.Echocardiogram.isValidEchocardiogram(data, out errors))
                    {
                        isInserted = BusinessLogicLayer.ConsentForms.Echocardiogram.SaveEchocardiogram(data, madeby);

                        if (isInserted > 0)
                        {
                            PDF _pdf = CreatePDF(data.ern_appId, "Echocardiogram");
                            return Json(new { isInserted = true, isSuccess = true, message = "Done" }, JsonRequestBehavior.AllowGet);
                        }
                        else
                        {
                            return Json(new { isInserted = false, isSuccess = true, message = "Echocardiogram Form is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        public PartialViewResult UpdateEchocardiogram(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Create;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    BusinessEntities.ConsentForms.Echocardiogram ophtha = BusinessLogicLayer.ConsentForms.Echocardiogram.GetEchocardiogramData(appId).FirstOrDefault();
                    return PartialView("UpdateEchocardiogram", ophtha);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public ActionResult EditEchocardiogram(BusinessEntities.ConsentForms.Echocardiogram data)
        {
            int isEdited = 0;
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    ...
                    if (SecurityLayer.FormValidations.ConsentForms.Echocardiogram.isValidEchocardiogram(data, out errors))
                    {
                        isEdited = BusinessLogicLayer.ConsentForms.Echocardiogram.SaveEchocardiogram(data, madeby);
                        ...
                        {
                            return Json(new { isEdited = false, isSuccess = true, message = "Echocardiogram Form is already exists!" }, JsonRequestBehavior.AllowGet);
                        }
                    }
                    else
                    {
        ...
        // Delete 
        [HttpPost]
        public ActionResult DeleteEchocardiogram(int appId)
        {
            try
            {
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    int val = BusinessLogicLayer.ConsentForms.Echocardiogram.DeleteEchocardiogram(appId, madeby);
        ...
        public PartialViewResult EchocardiogramPreviousHistory(int appId)
        {
            if (PageControl.getLoggedinId() > 0)
            {
                int Action = (int)Actions.Read;
                ...
                if (PageControl.haveAccess(PageId, Action))
                {
                    List<BusinessEntities.ConcentForms.ConcentPreviousHistory> list = BusinessLogicLayer.ConsentForms.Echocardiogram.GetEchocardiogramPreviousHistory(appId);
                    return PartialView("EchocardiogramPreviousHistory", list);
                }
                else
                {
                    return PartialView("_Unauthorized");
        ...
        public PDF CreatePDF(int appId, string form)
        {
            ...
            try
            {
                ...
                string htmlContent = BusinessLogicLayer.ConcentForms.ConcentFormPDF.HtmlEchocardiogram(appId, emr, setId);
