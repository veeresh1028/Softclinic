...
namespace BusinessLogicLayer.Appointment.DHA_Reports
{
    ...
    {
        public static List<BusinessEntities.Appointment.DHA_Reports.ResidentPatientsData> SearchResidentPatientsDataReport(ResidentPatientsDataReportSearch search)
        {
            try
            {
                List<BusinessEntities.Appointment.DHA_Reports.ResidentPatientsData> reports = new List<BusinessEntities.Appointment.DHA_Reports.ResidentPatientsData>();

                DataSet ds = DataAccessLayer.Appointment.DHA_Reports.ResidentPatientsData.SearchResidentPatientsDataReport(search);
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            BusinessEntities.Appointment.DHA_Reports.ResidentPatientsData report = new BusinessEntities.Appointment.DHA_Reports.ResidentPatientsData();
