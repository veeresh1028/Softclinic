...
{
    public class EmiratiPatientsData
    {
        public static List<BusinessEntities.Appointment.DHA_Reports.EmiratiPatientsData> SearchEmiratiPatientsDataReport(EmiratiPatientsDataReportSearch search)
        {
            try
            {
                List<BusinessEntities.Appointment.DHA_Reports.EmiratiPatientsData> reports = new List<BusinessEntities.Appointment.DHA_Reports.EmiratiPatientsData>();

                DataSet ds = DataAccessLayer.Appointment.DHA_Reports.EmiratiPatientsData.SearchEmiratiPatientsDataReport(search);
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            BusinessEntities.Appointment.DHA_Reports.EmiratiPatientsData report = new BusinessEntities.Appointment.DHA_Reports.EmiratiPatientsData();
