...
namespace BusinessLogicLayer.Reports
{
    ...
    {
        public static BusinessEntities.Reports.DoctorswiseSummaryReport SearchDoctorswiseReport(DoctorswiseSummarySearch search)
        {
            try
            {
                ...
                DataSet ds = DataAccessLayer.Reports.DoctorswiseSummaryReport.SearchDoctorswiseReport(search);
