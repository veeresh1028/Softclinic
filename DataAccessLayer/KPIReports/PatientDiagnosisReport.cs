...
namespace DataAccessLayer.KPIReports
{
    ...
    {
        public static DataTable SearchPatientDiagnosisReport(BusinessEntities.KPIReports.PatientDiagnosisReportSearch _filters)
        {
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                Database db = factory.CreateDefault();
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_PATIENT_DIAGNOSIS_REPORT");
                ...
                if (!string.IsNullOrEmpty(_filters.diagnosis))
                {
                    db.AddInParameter(dbCommand, "select_diagnosis", DbType.String, _filters.diagnosis);
                }
        ...
        public static DataTable GetPatientsByDiagnosis(GetPatients patient)
        {
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_SEARCH_PATIENTS_BY_DIAGNOSIS");
        ...
        public static DataTable GetDiagnosis(SearchQuery patient)
        {
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_SEARCH_DIAGNOSIS_BY_PAT_DIAGNOSIS");
                db.AddInParameter(dbCommand, "query", DbType.String, patient.query);
