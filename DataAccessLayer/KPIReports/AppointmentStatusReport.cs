...
namespace DataAccessLayer.KPIReports
{
    ...
    {
        public static DataTable SearchAppointmentStatusReport(BusinessEntities.KPIReports.AppointmentStatusSearch _filters)
        {
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                Database db = factory.CreateDefault();
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_APPOINTMENT_STATUS_REPORT");
        ...
        public static DataTable SearchAppointments(AppointmentSearch filters)
        {
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                Database db = factory.CreateDefault();
                DbCommand dbCommand = db.GetStoredProcCommand("SP_Search_Appointments_Status_Details");
