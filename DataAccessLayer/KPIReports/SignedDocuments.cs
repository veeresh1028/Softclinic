...
namespace DataAccessLayer.KPIReports
{
    ...
    {
        public static DataTable SearchSignedDocumentsReport(BusinessEntities.KPIReports.VitalSignsReportSearch _filters)
        {
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                Database db = factory.CreateDefault();
                DbCommand dbCommand = db.GetStoredProcCommand("SpGet_SignedDocuments_Report");
        ...
        public static DataTable GetPatientsBySignedDocumentsReport(GetPatients patient)
        {
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
