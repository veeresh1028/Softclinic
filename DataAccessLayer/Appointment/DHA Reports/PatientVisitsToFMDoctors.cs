...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchPatientVisitsToFMDoctors(PatientVisitsToFMDoctorsSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_PATIENTS_VISITS_TO_FM_DOCTORS");
