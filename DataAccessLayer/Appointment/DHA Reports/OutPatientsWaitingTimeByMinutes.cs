...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchPatientVisitByDiagnosis(OutPatientsWaitingTimeReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_OUT_PATIENTS_WAITING_TO_MEET_PHYSICIAN");
