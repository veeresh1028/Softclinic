...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchRadiologyExaminationsReport(RadiologyExaminationsReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_RADIOLOGY_EXAMINATIONS_REPORT");
