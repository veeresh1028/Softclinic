...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchAboveFiveImmunizationsReport(AboveFiveImmunizationsSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_ABOVE_FIVE_IMMNUNIZATIONS");
