...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataSet SearchInternationalPatientsDataReport(InternationalPatientsDataReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_INTERNATIONAL_PATIENTS_DATA");
