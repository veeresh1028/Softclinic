...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchDentalPatientsAndTreatmentsReport(DentalPatientsAndTreatmentsSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_DENTAL_PATIENTS_AND_TREATMENTS");
