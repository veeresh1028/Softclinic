...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchPatientFollowUpVisits(PatientCountFollowUpVisitsSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_PATIENTS_BY_FOLLOW_UP_VISITS");
