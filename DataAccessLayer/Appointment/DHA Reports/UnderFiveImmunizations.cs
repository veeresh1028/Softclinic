...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchUnderFiveImmunizationsReport(UnderFiveImmunizationsSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_UNDER_FIVE_IMMNUNIZATIONS");
