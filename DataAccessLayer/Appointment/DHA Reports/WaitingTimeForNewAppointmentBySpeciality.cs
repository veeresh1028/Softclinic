...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchWaitingTimeForNewAppointmentReport(WaitingTimeForNewAppointmentReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_WAITING_TIME_FOR_NEW_APPOINTMENT_REPORT");
