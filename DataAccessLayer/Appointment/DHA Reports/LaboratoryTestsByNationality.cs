...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchLaboratoryTestsByNationality(LaboratoryTestsReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_LABORATORY_TESTS_BY_NATIONALITY");
        ...
        public static DataTable SearchLaboratoryTestsReport(LaboratoryTestsReportSearch filters)
        {
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_LABORATORY_TESTS_BY_NATIONALITY_TYPE_OF_TEST");
