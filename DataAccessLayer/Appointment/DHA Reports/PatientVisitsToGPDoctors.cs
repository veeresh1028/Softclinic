...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchPatientVisitsToGPDoctors(PatientVisitsToGPDoctorsSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_PATIENTS_VISITS_TO_GP_DOCTORS");
