...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchLaboratoryTestsByNationality(DentalPatientTreatmentReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_DENTAL_PATIENT_TREATMENT_BY_NATIONALITY");
