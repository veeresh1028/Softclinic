...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchPatientsByNationalityTreatments(PatientsTreatmentsReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_NO_PATIENTS_BY_NATIONALITY_TREATMENTS");
