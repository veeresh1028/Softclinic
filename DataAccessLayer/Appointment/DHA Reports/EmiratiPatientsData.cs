...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataSet SearchEmiratiPatientsDataReport(EmiratiPatientsDataReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_EMIRATI_PATIENTS_DATA");
