...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchOutPatientStatisticsReport(OutPatientStatisticsReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_OUT_PATIENTS_STATISTICS_REPORT");
