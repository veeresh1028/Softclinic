...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchOutPatientsRehabilitationReport(OutPatientsRehabilitationReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_OUT_PATIENTS_REHABILITATION_PHYSIOTHERAPY_TREATMENT_REPORT");
