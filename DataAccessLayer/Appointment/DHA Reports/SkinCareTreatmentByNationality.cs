...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchSkinCareTreatmentReport(SkinCareTreatmentReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_SKIN_CARE_TREATMENT_BY_NATIONALITY");
