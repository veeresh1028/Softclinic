...
namespace DataAccessLayer.Appointment.DHA_Reports
{
    ...
    {
        public static DataTable SearchRehabilitationPhysiotherapyReport(RehabilitationReportSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DHA_REHABILITATION_PHYSIOTHERAPY_TREATMENT_REPORT");
