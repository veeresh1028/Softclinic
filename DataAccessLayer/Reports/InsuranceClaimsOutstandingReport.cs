...
namespace DataAccessLayer.Reports
{
    ...
    {
        public static DataTable SearchInsuranceClaimsOutstandingReport(InsuranceClaimsOutstandingSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_INSURANCE_CLAIMS_OUTSTANDING_REPORT");
