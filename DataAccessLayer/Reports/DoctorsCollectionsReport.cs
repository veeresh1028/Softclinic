...
namespace DataAccessLayer.Reports
{
    ...
    {
        public static DataTable GetDoctorsCollectionsReport(DoctorsCollectionsSearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DOCTORS_COLLECTIONS_REPORT");
