...
namespace DataAccessLayer.Reports
{
    ...
    {
        public static DataSet SearchDoctorsAndBranchwiseReport(DoctorsAndBranchwiseSummarySearch filters)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_DOCTOR_AND_BRANCHWISE_SUMMARY_REPORT");
