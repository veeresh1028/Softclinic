...
namespace DataAccessLayer.Reports
{
    ...
    {
        public static DataTable SearchReferredByMeReport(ReferredByMeReportSearch search)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_GET_APPOINTMENT_REFERRED_BY_ME_REPORT");
