...
namespace DataAccessLayer.Reports
{
    ...
    {
        public static DataTable GetPreSubmissionReport(PreSubmissionReportSearch search)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommand("SP_Get_Pre_Submissions_Report");
